...
//   At: 2023-10-02T09:56:46.4038385+01:00
//
...
public partial class SensorEntities
{
    ...
    ///<summary>Andy Body temperature</summary>
    ...
    ///<summary>Andy Diastolic blood pressure</summary>
    ...
    ///<summary>Andy Heart pulse</summary>
    ...
    ///<summary>Andy Pulse wave velocity</summary>
    ...
    ///<summary>Andy Skin temperature</summary>
    ...
    ///<summary>Andy Systolic blood pressure</summary>
    ...
    ///<summary>Andy Temperature</summary>
...
public partial record TextEntity : Entity<TextEntity, EntityState<TextAttributes>, TextAttributes>
{
    ...
    public TextEntity(Entity entity) : base(entity)
    {
    }
}
...
{
    ///<summary>Get weather forecast.</summary>
    public static void GetForecast(this WeatherEntity target, WeatherGetForecastParameters data)
    {
        target.CallService("get_forecast", data);
    }

    ///<summary>Get weather forecast.</summary>
    public static void GetForecast(this IEnumerable<WeatherEntity> target, WeatherGetForecastParameters data)
    {
        target.CallService("get_forecast", data);
    }
    ...
    ///<param name="type">Forecast type: daily, hourly or twice daily.</param>
    public static void GetForecast(this WeatherEntity target, object @type)
    {
    ...
    ///<param name="type">Forecast type: daily, hourly or twice daily.</param>
    public static void GetForecast(this IEnumerable<WeatherEntity> target, object @type)
    {
        target.CallService("get_forecast", new WeatherGetForecastParameters { Type = @type });
    }
}
